...
class Productos extends Controller{
    ...
    {
        $this->views->getView('productos', "index");
    }
    ...
    public function registrar()
    {
        ...
        if (empty($codigo) || empty($nombre) || empty($precio_compra) || empty($precio_venta)) {
            ...
            if ($id == "") {
                    $data = $this->model->registrarProducto($codigo, $nombre, $precio_compra, $precio_venta, $minimo,$imgNombre);
                    if ($data == "ok") {
                        if (!empty($name)) {
                ...
                $data = $this->model->modificarProducto($codigo, $nombre, $precio_compra, $precio_venta, $minimo,$imgNombre, $id);
                if ($data == "modificado") {
                    if (!empty($name)) {
                        move_uploaded_file($tmpname, $destino);
                    }
