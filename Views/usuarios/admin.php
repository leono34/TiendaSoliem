            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="identidad" class="form-control" type="text" name="identidad" value="<?php echo $data['identidad'] ?>" placeholder="Identidad" onkeypress="return soloNumeros(event);" oninput="longitud(event, 11)">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="telefono" class="form-control" type="text" name="telefono" value="<?php echo $data['telefono'] ?>" placeholder="Teléfono" onkeypress="return soloNumeros(event);" oninput="longitud(event, 9)">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="direccion">Dirección</label>
                        <textarea id="direccion" class="form-control" name="direccion" rows="3" placeholder="Dirección"><?php echo $data['direccion'] ?></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
